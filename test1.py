...
def fun():
    ...
    Label(root,text='Jubiliant Foods',relief='ridge',font='Times 20 bold italic',bg='grey',).grid(row=0,column=3)
    ...
    def check():
        if str(f.get())==' ' or str(e.get())==' ':
            showerror('error','Complete the fields')
        else:    
            ...
            if x>10:
                ...
                Label(root,text='Please visit us again!!!!!',font='Times 15 bold italic').grid(row=16,column=0)
            elif x<=10:
